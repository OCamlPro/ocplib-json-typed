...
module Make (Repr : Json_repr.Repr) : sig
  ...
  val custom :
    ('t -> Repr.value) ->
    (Repr.value -> 't) ->
    schema: Json_schema.Make (Repr).schema ->
    't encoding
